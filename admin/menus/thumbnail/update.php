...
if($action=="delete") {
	foreach ($id_array as $id_thumbnail) {
		mysql_query("DELETE from tbl_menus_thumbnail WHERE id_thumbnail = '$id'",$con); } }
			...
			$_POST["order_".$counter]!=null;$counter++) {
				...
				mysql_query("UPDATE tbl_menus_thumbnail SET order_='$order' WHERE id_thumbnail='$id_thumbnail'",$con); } }
